...
import {
  CapLevelController,
  Hls
} from "./chunk-4KNAAOBQ.js";
import {
  CustomVideoElement,
  MediaTracksMixin
} from "./chunk-64GFZFHW.js";
import {
  require_react
...
function loadCastFramework() {
  ...
  if (((_a3 = globalThis.chrome) == null ? void 0 : _a3.cast) || document.querySelector(`script[src="${sdkUrl}"]`)) return;
...
async function getPlaylistSegmentFormat(url) {
  if (!url || url.startsWith("blob:")) return void 0;
  try {
...
onCastApiAvailable(() => {
  ...
  if (!cf) {
    ...
    castContext().addEventListener(cf.CastContextEventType.CAST_STATE_CHANGED, (e) => {
      remoteInstances.forEach((r14) => {
        var _a4, _b2;
        return (_b2 = (_a4 = privateProps.get(r14)).onCastStateChanged) == null ? void 0 : _b2.call(_a4, e);
      });
    });
    castContext().addEventListener(cf.CastContextEventType.SESSION_STATE_CHANGED, (e) => {
      remoteInstances.forEach((r14) => {
        var _a4, _b2;
        return (_b2 = (_a4 = privateProps.get(r14)).onSessionStateChanged) == null ? void 0 : _b2.call(_a4, e);
      });
    });
    remoteInstances.forEach((r14) => {
      var _a4, _b2;
      return (_b2 = (_a4 = privateProps.get(r14)).init) == null ? void 0 : _b2.call(_a4);
    });
  }
});
var remotePlaybackCallbackIdCount = 0;
var _media, _isInit, _remotePlayer, _remoteListeners, _state, _available, _callbacks, _callbackIds, _onTextTrackChange, _RemotePlayback_instances, castPlayer_get, disconnect_fn, hasDevicesAvailable_fn, onCastStateChanged_fn, onSessionStateChanged_fn, init_fn, onRemoteMediaLoaded_fn, updateRemoteTextTrack_fn;
var RemotePlayback = class extends EventTarget {
  ...
  destroy() {
    var _a3, _b, _c;
    (_b = (_a3 = __privateGet(this, _media)) == null ? void 0 : _a3.textTracks) == null ? void 0 : _b.removeEventListener("change", __privateGet(this, _onTextTrackChange));
...
init_fn = function() {
  ...
  __privateSet(this, _remoteListeners, {
    ...
    [cf.RemotePlayerEventType.CURRENT_TIME_CHANGED]: () => {
      var _a3;
      if (!((_a3 = __privateGet(this, _RemotePlayback_instances, castPlayer_get)) == null ? void 0 : _a3.isMediaLoaded)) return;
    ...
    [cf.RemotePlayerEventType.PLAYER_STATE_CHANGED]: () => {
      var _a3, _b;
      if (((_a3 = __privateGet(this, _RemotePlayback_instances, castPlayer_get)) == null ? void 0 : _a3.playerState) === chrome.cast.media.PlayerState.PAUSED) {
        return;
      }
...
var CastableMediaMixin = (superclass) => {
  ...
  return _a3 = class extends superclass {
    ...
    disconnectedCallback() {
      var _a4, _b;
      (_a4 = __privateGet(this, _remote)) == null ? void 0 : _a4.destroy();
    ...
    play() {
      ...
      if (__privateGet(this, _CastableMedia_instances, castPlayer_get2)) {
        if (__privateGet(this, _CastableMedia_instances, castPlayer_get2).isPaused) {
          (_a4 = __privateGet(this, _CastableMedia_instances, castPlayer_get2).controller) == null ? void 0 : _a4.playOrPause();
        }
        return;
      }
      return super.play();
    ...
    get castSrc() {
      ...
      return this.getAttribute("cast-src") ?? ((_a4 = this.querySelector("source")) == null ? void 0 : _a4.src) ?? resolvedSrc ?? this.getAttribute("src") ?? void 0;
    }
    set castSrc(val) {
    ...
    get muted() {
      var _a4;
      if (__privateGet(this, _CastableMedia_instances, castPlayer_get2)) return (_a4 = __privateGet(this, _CastableMedia_instances, castPlayer_get2)) == null ? void 0 : _a4.isMuted;
      return super.muted;
    }
    set muted(val) {
      var _a4;
      if (__privateGet(this, _CastableMedia_instances, castPlayer_get2)) {
        if (val && !__privateGet(this, _CastableMedia_instances, castPlayer_get2).isMuted || !val && __privateGet(this, _CastableMedia_instances, castPlayer_get2).isMuted) {
          (_a4 = __privateGet(this, _CastableMedia_instances, castPlayer_get2).controller) == null ? void 0 : _a4.muteOrUnmute();
        }
        return;
      }
      super.muted = val;
    ...
    get volume() {
      var _a4;
      if (__privateGet(this, _CastableMedia_instances, castPlayer_get2)) return ((_a4 = __privateGet(this, _CastableMedia_instances, castPlayer_get2)) == null ? void 0 : _a4.volumeLevel) ?? 1;
      return super.volume;
    }
    set volume(val) {
      var _a4;
      if (__privateGet(this, _CastableMedia_instances, castPlayer_get2)) {
        ...
        (_a4 = __privateGet(this, _CastableMedia_instances, castPlayer_get2).controller) == null ? void 0 : _a4.setVolumeLevel();
        return;
      }
      super.volume = val;
    }
    get duration() {
      var _a4, _b;
      if (__privateGet(this, _CastableMedia_instances, castPlayer_get2) && ((_a4 = __privateGet(this, _CastableMedia_instances, castPlayer_get2)) == null ? void 0 : _a4.isMediaLoaded)) {
    ...
    set currentTime(val) {
      ...
      if (__privateGet(this, _CastableMedia_instances, castPlayer_get2)) {
        ...
        (_a4 = __privateGet(this, _CastableMedia_instances, castPlayer_get2).controller) == null ? void 0 : _a4.seek();
        return;
      }
...
var MediaGestureReceiver = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b = (_a3 = __privateGet2(this, _mediaController)) == null ? void 0 : _a3.unassociateElement) == null ? void 0 : _b.call(_a3, this);
  ...
  connectedCallback() {
    ...
    if (this.getAttribute(MediaStateReceiverAttributes.MEDIA_CONTROLLER)) {
      (_b = (_a3 = __privateGet2(this, _mediaController)) == null ? void 0 : _a3.associateElement) == null ? void 0 : _b.call(_a3, this);
    }
    if (!__privateGet2(this, _mediaController))
      return;
    __privateGet2(this, _mediaController).addEventListener("pointerdown", this);
    __privateGet2(this, _mediaController).addEventListener("click", this);
    if (!__privateGet2(this, _mediaController).hasAttribute("tabindex")) {
      __privateGet2(this, _mediaController).tabIndex = 0;
    }
  }
  disconnectedCallback() {
    var _a3, _b, _c, _d;
...
var MediaContainer = class extends GlobalThis.HTMLElement {
  constructor() {
    ...
    __privateAdd3(this, _mutationObserver, void 0);
    ...
    __privateAdd3(this, _handleMutation, (mutationsList) => {
    ...
    __privateAdd3(this, _chainedSlot, void 0);
    __privateAdd3(this, _handleSlotChange, () => {
      const slotEls = __privateGet3(this, _chainedSlot).assignedElements({ flatten: true });
      if (!slotEls.length) {
    ...
    __privateSet3(this, _mutationObserver, new MutationObserver(__privateGet3(this, _handleMutation)));
  }
  static get observedAttributes() {
  ...
  connectedCallback() {
    ...
    if (chainedSlot) {
      __privateSet3(this, _chainedSlot, chainedSlot);
      __privateGet3(this, _chainedSlot).addEventListener("slotchange", __privateGet3(this, _handleSlotChange));
    }
  ...
  disconnectedCallback() {
    ...
    if (__privateGet3(this, _chainedSlot)) {
      __privateGet3(this, _chainedSlot).removeEventListener("slotchange", __privateGet3(this, _handleSlotChange));
      __privateSet3(this, _chainedSlot, null);
    }
    __privateSet3(this, _isResizePending, false);
  }
  /**
...
var MediaController = class extends MediaContainer {
  ...
  connectedCallback() {
    ...
    if (__privateGet5(this, _mediaStore) && !__privateGet5(this, _mediaStoreUnsubscribe)) {
      __privateSet5(this, _mediaStoreUnsubscribe, (_c = __privateGet5(this, _mediaStore)) == null ? void 0 : _c.subscribe(
        __privateGet5(this, _mediaStateCallback)
      ));
    }
    if (__privateGet5(this, _subtitlesState) !== void 0 && __privateGet5(this, _mediaStore) && this.media) {
      setTimeout(() => {
        ...
        if ((_b2 = (_a22 = this.media) == null ? void 0 : _a22.textTracks) == null ? void 0 : _b2.length) {
          (_c2 = __privateGet5(this, _mediaStore)) == null ? void 0 : _c2.dispatch({
  ...
  disconnectedCallback() {
    ...
    if (__privateGet5(this, _mediaStoreUnsubscribe)) {
      (_f = __privateGet5(this, _mediaStoreUnsubscribe)) == null ? void 0 : _f.call(this);
      __privateSet5(this, _mediaStoreUnsubscribe, void 0);
    }
    this.unassociateElement(this);
    if (__privateGet5(this, _keyboardShortcutsDialog)) {
      __privateGet5(this, _keyboardShortcutsDialog).remove();
      __privateSet5(this, _keyboardShortcutsDialog, null);
    }
  }
  /**
   * @override
...
keyDownHandler_fn = function(e) {
  ...
  const isShiftSlash = shiftKey && (key === "/" || key === "?");
  if (isShiftSlash && ((_a3 = __privateGet5(this, _keyboardShortcutsDialog)) == null ? void 0 : _a3.open)) {
    this.removeEventListener("keyup", __privateGet5(this, _keyUpHandler));
    return;
  }
  ...
  this.addEventListener("keyup", __privateGet5(this, _keyUpHandler), { once: true });
};
...
var MediaChromeButton = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b = (_a3 = __privateGet6(this, _mediaController2)) == null ? void 0 : _a3.unassociateElement) == null ? void 0 : _b.call(_a3, this);
...
var MediaChromeRange = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b = (_a3 = __privateGet8(this, _mediaController3)) == null ? void 0 : _a3.unassociateElement) == null ? void 0 : _b.call(_a3, this);
...
var MediaControlBar = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b = (_a3 = __privateGet9(this, _mediaController4)) == null ? void 0 : _a3.unassociateElement) == null ? void 0 : _b.call(_a3, this);
...
var MediaTextDisplay = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
      if (oldValue) {
        (_b = (_a3 = __privateGet10(this, _mediaController5)) == null ? void 0 : _a3.unassociateElement) == null ? void 0 : _b.call(_a3, this);
...
var MediaDurationDisplay = class extends MediaTextDisplay {
  constructor() {
    ...
    __privateGet11(this, _slot).textContent = formatTime((_a3 = this.mediaDuration) != null ? _a3 : 0);
  }
  static get observedAttributes() {
...
var MediaLoadingIndicator = class extends GlobalThis.HTMLElement {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === Attributes6.LOADING_DELAY && oldValue !== newValue) {
      ...
      if (oldValue) {
        (_b = (_a3 = __privateGet15(this, _mediaController6)) == null ? void 0 : _a3.unassociateElement) == null ? void 0 : _b.call(_a3, this);
  ...
  connectedCallback() {
    ...
    if (mediaControllerId) {
      __privateSet14(this, _mediaController6, (_a3 = this.getRootNode()) == null ? void 0 : _a3.getElementById(
        mediaControllerId
      ));
...
var MediaPreviewThumbnail = class extends GlobalThis.HTMLElement {
  ...
  disconnectedCallback() {
    var _a3, _b;
    (_b = (_a3 = __privateGet18(this, _mediaController7)) == null ? void 0 : _a3.unassociateElement) == null ? void 0 : _b.call(_a3, this);
...
var MediaTimeDisplay = class extends MediaTextDisplay {
  constructor() {
    super();
    __privateAdd20(this, _setupEventListeners);
    __privateAdd20(this, _removeEventListeners);
    __privateAdd20(this, _makeInteractive);
    __privateAdd20(this, _makeNonInteractive);
    __privateAdd20(this, _slot4, void 0);
    __privateAdd20(this, _keyUpHandler2, null);
    __privateAdd20(this, _keyDownHandler3, (evt) => {
      const { metaKey, altKey, key } = evt;
      if (metaKey || altKey || !ButtonPressedKeys2.includes(key)) {
        this.removeEventListener("keyup", __privateGet20(this, _keyUpHandler2));
        return;
      }
      this.addEventListener("keyup", __privateGet20(this, _keyUpHandler2));
    });
  ...
  connectedCallback() {
    ...
    __privateMethod7(this, _makeInteractive, makeInteractive_fn).call(this);
    super.connectedCallback();
  }
  toggleTimeDisplay() {
    if (this.noToggle) {
  ...
  disconnectedCallback() {
    this.disable();
    __privateMethod7(this, _removeEventListeners, removeEventListeners_fn).call(this);
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (CombinedAttributes.includes(attrName)) {
      ...
      if (newValue == null) {
        ...
        __privateMethod7(this, _makeNonInteractive, makeNonInteractive_fn).call(this);
      }
...
setupEventListeners_fn = function() {
  if (__privateGet20(this, _keyUpHandler2)) {
    return;
  }
  __privateSet18(this, _keyUpHandler2, (evt) => {
    const { key } = evt;
  ...
  this.addEventListener("keydown", __privateGet20(this, _keyDownHandler3));
...
removeEventListeners_fn = function() {
  if (__privateGet20(this, _keyUpHandler2)) {
    this.removeEventListener("keyup", __privateGet20(this, _keyUpHandler2));
    this.removeEventListener("keydown", __privateGet20(this, _keyDownHandler3));
    this.removeEventListener("click", this.toggleTimeDisplay);
    __privateSet18(this, _keyUpHandler2, null);
  }
};
...
makeInteractive_fn = function() {
  if (!this.noToggle && !this.hasAttribute("disabled")) {
    this.setAttribute("role", "button");
    this.enable();
    __privateMethod7(this, _setupEventListeners, setupEventListeners_fn).call(this);
  }
};
...
var MediaTimeRange = class extends MediaChromeRange {
  constructor() {
    ...
    __privateAdd22(this, _rootNode, null);
    ...
    __privateAdd22(this, _toggleRangeAnimation, () => {
      if (__privateMethod8(this, _shouldRangeAnimate, shouldRangeAnimate_fn).call(this)) {
  ...
  connectedCallback() {
    ...
    __privateGet22(this, _toggleRangeAnimation).call(this);
    __privateSet20(this, _rootNode, this.getRootNode());
    (_a3 = __privateGet22(this, _rootNode)) == null ? void 0 : _a3.addEventListener("transitionstart", this);
  }
  disconnectedCallback() {
    var _a3;
    super.disconnectedCallback();
    __privateGet22(this, _animation).stop();
    (_a3 = __privateGet22(this, _rootNode)) == null ? void 0 : _a3.removeEventListener("transitionstart", this);
  ...
  set mediaChaptersCues(value) {
    ...
    this.updateSegments(
      (_a3 = __privateGet22(this, _mediaChaptersCues)) == null ? void 0 : _a3.map((c4) => ({
  ...
  updateCurrentBox() {
    ...
    const rects = __privateMethod8(this, _getElementRects, getElementRects_fn).call(this, __privateGet22(this, _currentBox));
    const boxPos = __privateMethod8(this, _getBoxPosition, getBoxPosition_fn).call(this, rects, this.range.valueAsNumber);
    const boxShift = __privateMethod8(this, _getBoxShiftPosition, getBoxShiftPosition_fn).call(this, rects, this.range.valueAsNumber);
  ...
  handleEvent(evt) {
    ...
    switch (evt.type) {
      case "input":
        __privateMethod8(this, _seekRequest, seekRequest_fn).call(this);
        break;
      case "pointermove":
        __privateMethod8(this, _handlePointerMove3, handlePointerMove_fn3).call(this, evt);
        break;
      case "pointerup":
        if (__privateGet22(this, _isPointerDown))
      ...
      case "pointerdown":
        ...
        break;
      case "pointerleave":
        __privateMethod8(this, _previewRequest, previewRequest_fn).call(this, null);
        break;
      case "transitionstart":
        if (containsComposedNode(evt.target, this)) {
          setTimeout(() => __privateGet22(this, _toggleRangeAnimation).call(this), 0);
        }
        break;
    }
  }
...
handlePointerMove_fn3 = function(evt) {
  ...
  const rects = __privateMethod8(this, _getElementRects, getElementRects_fn).call(this, __privateGet22(this, _previewBox));
  let pointerRatio = (evt.clientX - rects.range.left) / rects.range.width;
  pointerRatio = Math.max(0, Math.min(1, pointerRatio));
  const boxPos = __privateMethod8(this, _getBoxPosition, getBoxPosition_fn).call(this, rects, pointerRatio);
  const boxShift = __privateMethod8(this, _getBoxShiftPosition, getBoxShiftPosition_fn).call(this, rects, pointerRatio);
  ...
  __privateMethod8(this, _previewRequest, previewRequest_fn).call(this, __privateGet22(this, _previewTime));
};
...
var MediaVolumeRange = class extends MediaChromeRange {
  constructor() {
    super(...arguments);
    __privateAdd23(this, _handleRangeInput, () => {
  ...
  connectedCallback() {
    ...
    this.range.addEventListener("input", __privateGet23(this, _handleRangeInput));
  }
  disconnectedCallback() {
    this.range.removeEventListener("input", __privateGet23(this, _handleRangeInput));
    super.disconnectedCallback();
  }
  attributeChangedCallback(attrName, oldValue, newValue) {
    super.attributeChangedCallback(attrName, oldValue, newValue);
...
var TemplateInstance = class extends GlobalThis.DocumentFragment {
  constructor(template, state, processor2 = defaultProcessor) {
    var _a3;
    super();
    __privateAdd24(this, _parts, void 0);
    __privateAdd24(this, _processor, void 0);
    this.append(template.content.cloneNode(true));
    __privateSet21(this, _parts, parse(this));
    __privateSet21(this, _processor, processor2);
    (_a3 = processor2.createCallback) == null ? void 0 : _a3.call(processor2, this, __privateGet24(this, _parts), state);
    processor2.processCallback(this, __privateGet24(this, _parts), state);
  }
  update(state) {
    __privateGet24(this, _processor).processCallback(this, __privateGet24(this, _parts), state);
  }
};
...
var AttrPartList = class {
  constructor() {
    __privateAdd24(this, _items, []);
  }
  [Symbol.iterator]() {
    return __privateGet24(this, _items).values();
  }
  get length() {
    return __privateGet24(this, _items).length;
  }
  item(index) {
    return __privateGet24(this, _items)[index];
  }
  append(...items) {
    for (const item of items) {
      ...
      __privateGet24(this, _items).push(item);
    }
  }
  toString() {
    return __privateGet24(this, _items).join("");
  }
};
...
var AttrPart = class extends Part {
  constructor(element, attributeName, namespaceURI) {
    super();
    __privateAdd24(this, _list);
    __privateAdd24(this, _value, "");
    __privateAdd24(this, _element, void 0);
    __privateAdd24(this, _attributeName, void 0);
    __privateAdd24(this, _namespaceURI, void 0);
  ...
  get attributeName() {
    return __privateGet24(this, _attributeName);
  }
  get attributeNamespace() {
    return __privateGet24(this, _namespaceURI);
  }
  get element() {
    return __privateGet24(this, _element);
  }
  get value() {
    return __privateGet24(this, _value);
  }
  set value(newValue) {
    if (__privateGet24(this, _value) === newValue)
      return;
    __privateSet21(this, _value, newValue);
    if (!__privateGet24(this, _list, list_get) || __privateGet24(this, _list, list_get).length === 1) {
      if (newValue == null) {
        __privateGet24(this, _element).removeAttributeNS(
          __privateGet24(this, _namespaceURI),
          __privateGet24(this, _attributeName)
        );
      } else {
        __privateGet24(this, _element).setAttributeNS(
          __privateGet24(this, _namespaceURI),
          __privateGet24(this, _attributeName),
          newValue
        );
      ...
      __privateGet24(this, _element).setAttributeNS(
        __privateGet24(this, _namespaceURI),
        __privateGet24(this, _attributeName),
        __privateGet24(this, _list, list_get).toString()
      );
    }
  }
  get booleanValue() {
    return __privateGet24(this, _element).hasAttributeNS(
      __privateGet24(this, _namespaceURI),
      __privateGet24(this, _attributeName)
    );
  }
...
var ChildNodePart = class extends Part {
  constructor(parentNode, nodes) {
    super();
    __privateAdd24(this, _parentNode, void 0);
    __privateAdd24(this, _nodes, void 0);
    __privateSet21(this, _parentNode, parentNode);
    __privateSet21(this, _nodes, nodes ? [...nodes] : [new Text()]);
  }
  get replacementNodes() {
    return __privateGet24(this, _nodes);
  }
  get parentNode() {
    return __privateGet24(this, _parentNode);
  }
  get nextSibling() {
    return __privateGet24(this, _nodes)[__privateGet24(this, _nodes).length - 1].nextSibling;
  }
  get previousSibling() {
    return __privateGet24(this, _nodes)[0].previousSibling;
  }
  // FIXME: not sure why do we need string serialization here? Just because parent class has type DOMString?
  get value() {
    return __privateGet24(this, _nodes).map((node) => node.textContent).join("");
  }
  set value(newValue) {
  ...
  replace(...nodes) {
    ...
    __privateSet21(this, _nodes, swapdom(
      __privateGet24(this, _nodes)[0].parentNode,
      __privateGet24(this, _nodes),
      normalisedNodes,
      this.nextSibling
    ));
  }
...
var MediaThemeElement = class extends GlobalThis.HTMLElement {
  constructor() {
    super();
    __privateAdd25(this, _upgradeProperty);
    __privateAdd25(this, _updateTemplate);
    __privateAdd25(this, _template, void 0);
    __privateAdd25(this, _prevTemplate, void 0);
    __privateAdd25(this, _prevTemplateId, void 0);
    __privateAdd25(this, _observer, void 0);
    __privateAdd25(this, _renderBind, void 0);
    if (this.shadowRoot) {
    ...
    __privateSet22(this, _observer, new MutationObserver((mutationList) => {
      var _a3;
    ...
    __privateSet22(this, _renderBind, this.render.bind(this));
    __privateMethod9(this, _upgradeProperty, upgradeProperty_fn).call(this, "template");
  }
  ...
  get template() {
    var _a3;
    return (_a3 = __privateGet25(this, _template)) != null ? _a3 : this.constructor.template;
  }
  set template(value) {
    if (value === null) {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    if (attrName === "template" && oldValue != newValue) {
      __privateMethod9(this, _updateTemplate, updateTemplate_fn).call(this);
    }
  }
  connectedCallback() {
    this.addEventListener(
      MediaStateChangeEvents.BREAKPOINTS_COMPUTED,
      __privateGet25(this, _renderBind)
    );
    __privateGet25(this, _observer).observe(this, { attributes: true });
    __privateGet25(this, _observer).observe(this.renderRoot, {
      attributes: true,
      subtree: true
    });
    __privateMethod9(this, _updateTemplate, updateTemplate_fn).call(this);
  ...
  disconnectedCallback() {
    ...
    __privateGet25(this, _observer).disconnect();
  }
  createRenderer() {
    if (this.template instanceof HTMLTemplateElement && this.template !== __privateGet25(this, _prevTemplate)) {
...
updateTemplate_fn = function() {
  ...
  if (!templateId || templateId === __privateGet25(this, _prevTemplateId))
    return;
...
var MediaChromeMenu = class extends GlobalThis.HTMLElement {
  constructor() {
    ...
    __privateAdd26(this, _toggleHeader);
    __privateAdd26(this, _updateLayoutStyle);
    __privateAdd26(this, _handleInvoke2);
    __privateAdd26(this, _handleOpen2);
    __privateAdd26(this, _handleClosed2);
    __privateAdd26(this, _positionMenu);
    __privateAdd26(this, _resizeMenu);
    __privateAdd26(this, _handleClick);
    __privateAdd26(this, _backButtonElement);
    __privateAdd26(this, _handleToggle);
    __privateAdd26(this, _checkSubmenuHasExpanded);
    __privateAdd26(this, _handleFocusOut2);
    __privateAdd26(this, _handleKeyDown2);
    __privateAdd26(this, _getItem);
    __privateAdd26(this, _getTabItem);
    __privateAdd26(this, _setTabItem);
    __privateAdd26(this, _selectItem);
    __privateAdd26(this, _mediaController8, null);
    __privateAdd26(this, _previouslyFocused2, null);
    __privateAdd26(this, _invokerElement2, null);
    __privateAdd26(this, _previousItems, /* @__PURE__ */ new Set());
    __privateAdd26(this, _mutationObserver2, void 0);
    __privateAdd26(this, _isPopover, false);
    __privateAdd26(this, _cssRule, null);
    __privateAdd26(this, _handleMenuItems, () => {
      const previousItems = __privateGet26(this, _previousItems);
    ...
    __privateAdd26(this, _handleBoundsResize, () => {
      __privateMethod10(this, _positionMenu, positionMenu_fn).call(this);
      __privateMethod10(this, _resizeMenu, resizeMenu_fn).call(this, false);
    });
    __privateAdd26(this, _handleMenuResize, () => {
      __privateMethod10(this, _positionMenu, positionMenu_fn).call(this);
    });
    if (!this.shadowRoot) {
      this.attachShadow(this.constructor.shadowRootOptions);
    ...
    __privateSet23(this, _mutationObserver2, new MutationObserver(__privateGet26(this, _handleMenuItems)));
  }
  static get observedAttributes() {
    return [
  ...
  handleEvent(event) {
    switch (event.type) {
      case "slotchange":
        __privateMethod10(this, _handleSlotChange2, handleSlotChange_fn).call(this, event);
        break;
      case "invoke":
        __privateMethod10(this, _handleInvoke2, handleInvoke_fn2).call(this, event);
        break;
      case "click":
        __privateMethod10(this, _handleClick, handleClick_fn).call(this, event);
        break;
      case "toggle":
        __privateMethod10(this, _handleToggle, handleToggle_fn).call(this, event);
        break;
      case "focusout":
        __privateMethod10(this, _handleFocusOut2, handleFocusOut_fn2).call(this, event);
        break;
      case "keydown":
        __privateMethod10(this, _handleKeyDown2, handleKeyDown_fn2).call(this, event);
        break;
    }
  }
  connectedCallback() {
    var _a3, _b;
    __privateGet26(this, _mutationObserver2).observe(this.defaultSlot, { childList: true });
    __privateSet23(this, _cssRule, insertCSSRule(this.shadowRoot, ":host"));
    __privateMethod10(this, _updateLayoutStyle, updateLayoutStyle_fn).call(this);
    if (!this.hasAttribute("disabled")) {
      this.enable();
    }
    if (!this.role) {
    ...
    (_b = (_a3 = __privateGet26(this, _mediaController8)) == null ? void 0 : _a3.associateElement) == null ? void 0 : _b.call(_a3, this);
    if (!this.hidden) {
      observeResize(getBoundsElement(this), __privateGet26(this, _handleBoundsResize));
      observeResize(this, __privateGet26(this, _handleMenuResize));
    }
    __privateMethod10(this, _toggleHeader, toggleHeader_fn).call(this);
    this.shadowRoot.addEventListener("slotchange", this);
  }
  disconnectedCallback() {
    var _a3, _b;
    __privateGet26(this, _mutationObserver2).disconnect();
    unobserveResize(getBoundsElement(this), __privateGet26(this, _handleBoundsResize));
    unobserveResize(this, __privateGet26(this, _handleMenuResize));
    this.disable();
    (_b = (_a3 = __privateGet26(this, _mediaController8)) == null ? void 0 : _a3.unassociateElement) == null ? void 0 : _b.call(_a3, this);
    __privateSet23(this, _mediaController8, null);
    __privateSet23(this, _previouslyFocused2, null);
    __privateSet23(this, _invokerElement2, null);
    this.shadowRoot.removeEventListener("slotchange", this);
  }
  attributeChangedCallback(attrName, oldValue, newValue) {
    var _a3, _b, _c, _d;
    if (attrName === Attributes12.HIDDEN && newValue !== oldValue) {
      if (!__privateGet26(this, _isPopover))
        __privateSet23(this, _isPopover, true);
      if (this.hidden) {
        __privateMethod10(this, _handleClosed2, handleClosed_fn2).call(this);
      } else {
        __privateMethod10(this, _handleOpen2, handleOpen_fn2).call(this);
      }
      this.dispatchEvent(
        new ToggleEvent({
      ...
      if (newValue && this.isConnected) {
        __privateSet23(this, _mediaController8, getAttributeMediaController(this));
        (_d = (_c = __privateGet26(this, _mediaController8)) == null ? void 0 : _c.associateElement) == null ? void 0 : _d.call(_c, this);
      }
  ...
  set value(newValue) {
    ...
    if (!item)
      return;
    __privateMethod10(this, _selectItem, selectItem_fn).call(this, item);
  }
  focus() {
    __privateSet23(this, _previouslyFocused2, getActiveElement());
    if (this.items.length) {
      __privateMethod10(this, _setTabItem, setTabItem_fn).call(this, this.items[0]);
      this.items[0].focus();
      return;
    }
    const focusable = this.querySelector(
  ...
  handleSelect(event) {
    var _a3;
    const item = __privateMethod10(this, _getItem, getItem_fn).call(this, event);
    if (!item)
      return;
    __privateMethod10(this, _selectItem, selectItem_fn).call(this, item, item.type === "checkbox");
    if (__privateGet26(this, _invokerElement2) && !this.hidden) {
      (_a3 = __privateGet26(this, _previouslyFocused2)) == null ? void 0 : _a3.focus();
      this.hidden = true;
    }
  }
  get keysUsed() {
  ...
  handleMove(event) {
    ...
    const currentItem = (_b = (_a3 = __privateMethod10(this, _getItem, getItem_fn).call(this, event)) != null ? _a3 : __privateMethod10(this, _getTabItem, getTabItem_fn).call(this)) != null ? _b : items[0];
    ...
    __privateMethod10(this, _setTabItem, setTabItem_fn).call(this, items[index]);
    items[index].focus();
  }
};
...
handleSlotChange_fn = function(event) {
  ...
  if (!slot.name) {
    __privateGet26(this, _handleMenuItems).call(this);
  }
};
...
handleOpen_fn2 = function() {
  var _a3;
  (_a3 = __privateGet26(this, _invokerElement2)) == null ? void 0 : _a3.setAttribute("aria-expanded", "true");
  this.addEventListener("transitionend", () => this.focus(), { once: true });
  observeResize(getBoundsElement(this), __privateGet26(this, _handleBoundsResize));
  observeResize(this, __privateGet26(this, _handleMenuResize));
};
...
handleClosed_fn2 = function() {
  var _a3;
  (_a3 = __privateGet26(this, _invokerElement2)) == null ? void 0 : _a3.setAttribute("aria-expanded", "false");
  unobserveResize(getBoundsElement(this), __privateGet26(this, _handleBoundsResize));
  unobserveResize(this, __privateGet26(this, _handleMenuResize));
};
...
positionMenu_fn = function(menuWidth) {
  ...
  const { style } = __privateGet26(this, _cssRule);
...
resizeMenu_fn = function(animate) {
  ...
  if (expandedSubmenu) {
    ...
    __privateMethod10(this, _positionMenu, positionMenu_fn).call(this, width);
  } else {
...
handleClick_fn = function(event) {
  var _a3;
  event.stopPropagation();
  if (event.composedPath().includes(__privateGet26(this, _backButtonElement, backButtonElement_get))) {
    (_a3 = __privateGet26(this, _previouslyFocused2)) == null ? void 0 : _a3.focus();
    this.hidden = true;
    return;
  }
  ...
  if (!item || item.hasAttribute("disabled"))
    return;
  __privateMethod10(this, _setTabItem, setTabItem_fn).call(this, item);
...
handleToggle_fn = function(event) {
  if (event.target === this)
    return;
  __privateMethod10(this, _checkSubmenuHasExpanded, checkSubmenuHasExpanded_fn).call(this);
  ...
  __privateMethod10(this, _resizeMenu, resizeMenu_fn).call(this, true);
};
...
handleFocusOut_fn2 = function(event) {
  ...
  if (!containsComposedNode(this, event.relatedTarget)) {
    ...
    if (__privateGet26(this, _invokerElement2) && __privateGet26(this, _invokerElement2) !== event.relatedTarget && !this.hidden) {
      this.hidden = true;
    }
  }
};
...
handleKeyDown_fn2 = function(event) {
  ...
  if (key === "Tab") {
    ...
    (_e4 = __privateGet26(this, _previouslyFocused2)) == null ? void 0 : _e4.focus();
    if (__privateGet26(this, _isPopover)) {
      this.hidden = true;
    }
...
var MediaChromeMenuItem = class extends GlobalThis.HTMLElement {
  constructor() {
    super();
    __privateAdd27(this, _handleSlotChange3);
    __privateAdd27(this, _submenuConnected);
    __privateAdd27(this, _submenuDisconnected);
    __privateAdd27(this, _reset);
    __privateAdd27(this, _dirty, false);
    __privateAdd27(this, _ownerElement, void 0);
    __privateAdd27(this, _handleMenuItem, () => {
      var _a3, _b;
    ...
    __privateAdd27(this, _handleKeyUp, (event) => {
      const { key } = event;
      if (!this.keysUsed.includes(key)) {
        this.removeEventListener("keyup", __privateGet27(this, _handleKeyUp));
        return;
      }
      this.handleClick(event);
    });
    __privateAdd27(this, _handleKeyDown3, (event) => {
      const { metaKey, altKey, key } = event;
      if (metaKey || altKey || !this.keysUsed.includes(key)) {
        this.removeEventListener("keyup", __privateGet27(this, _handleKeyUp));
        return;
      }
      this.addEventListener("keyup", __privateGet27(this, _handleKeyUp), { once: true });
    });
    if (!this.shadowRoot) {
      this.attachShadow(this.constructor.shadowRootOptions);
      const attrs = namedNodeMapToObject(this.attributes);
  ...
  handleEvent(event) {
    switch (event.type) {
      case "slotchange":
        __privateMethod11(this, _handleSlotChange3, handleSlotChange_fn2).call(this, event);
        break;
      case "click":
        this.handleClick(event);
        break;
      case "keydown":
        __privateGet27(this, _handleKeyDown3).call(this, event);
        break;
      case "keyup":
        __privateGet27(this, _handleKeyUp).call(this, event);
        break;
    }
  }
  attributeChangedCallback(attrName, oldValue, newValue) {
    if (attrName === Attributes13.CHECKED && isCheckable(this) && !__privateGet27(this, _dirty)) {
  ...
  connectedCallback() {
    ...
    __privateMethod11(this, _reset, reset_fn).call(this);
    if (this.submenuElement) {
      __privateMethod11(this, _submenuConnected, submenuConnected_fn).call(this);
    }
    this.shadowRoot.addEventListener("slotchange", this);
  }
  disconnectedCallback() {
...
handleSlotChange_fn2 = function(event) {
  ...
  if (slot.name === "submenu") {
    if (this.submenuElement) {
      ...
      __privateMethod11(this, _submenuDisconnected, submenuDisconnected_fn).call(this);
    }
  }
};
...
submenuConnected_fn = async function() {
  ...
  this.submenuElement.addEventListener("change", __privateGet27(this, _handleMenuItem));
  this.submenuElement.addEventListener("addmenuitem", __privateGet27(this, _handleMenuItem));
  this.submenuElement.addEventListener(
    "removemenuitem",
    __privateGet27(this, _handleMenuItem)
  );
  __privateGet27(this, _handleMenuItem).call(this);
};
_submenuDisconnected = /* @__PURE__ */ new WeakSet();
submenuDisconnected_fn = function() {
  this.removeAttribute("aria-haspopup");
  this.removeAttribute("aria-expanded");
  this.submenuElement.removeEventListener("change", __privateGet27(this, _handleMenuItem));
...
reset_fn = function() {
  var _a3;
  const items = (_a3 = __privateGet27(this, _ownerElement)) == null ? void 0 : _a3.radioGroupItems;
  if (!items)
    return;
...
var MediaAudioTrackMenu = class extends MediaChromeMenu {
  constructor() {
    super(...arguments);
    __privateAdd28(this, _render);
    __privateAdd28(this, _onChange);
    __privateAdd28(this, _audioTrackList, []);
    __privateAdd28(this, _prevState, void 0);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_AUDIO_TRACK_ENABLED && oldValue !== newValue) {
      ...
      __privateMethod12(this, _render, render_fn).call(this);
    }
  }
  connectedCallback() {
    super.connectedCallback();
    this.addEventListener("change", __privateMethod12(this, _onChange, onChange_fn));
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    this.removeEventListener("change", __privateMethod12(this, _onChange, onChange_fn));
  }
  /**
   * Returns the anchor element when it is a floating menu.
   */
  ...
  get mediaAudioTrackList() {
    return __privateGet28(this, _audioTrackList);
  }
...
render_fn = function() {
  if (__privateGet28(this, _prevState) === JSON.stringify(this.mediaAudioTrackList))
    return;
...
var MediaCaptionsMenu = class extends MediaChromeMenu {
  constructor() {
    super(...arguments);
    __privateAdd29(this, _render2);
    __privateAdd29(this, _onChange2);
    __privateAdd29(this, _prevState2, void 0);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_SUBTITLES_LIST && oldValue !== newValue) {
      __privateMethod13(this, _render2, render_fn2).call(this);
  ...
  connectedCallback() {
    super.connectedCallback();
    this.addEventListener("change", __privateMethod13(this, _onChange2, onChange_fn2));
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    this.removeEventListener("change", __privateMethod13(this, _onChange2, onChange_fn2));
  }
  /**
   * Returns the anchor element when it is a floating menu.
   */
...
render_fn2 = function() {
  var _a3;
  const hasListChanged = __privateGet29(this, _prevState2) !== JSON.stringify(this.mediaSubtitlesList);
...
var MediaPlaybackRateMenu = class extends MediaChromeMenu {
  constructor() {
    super();
    __privateAdd30(this, _render3);
    __privateAdd30(this, _onChange3);
    __privateAdd30(this, _rates2, new AttributeTokenList(this, Attributes14.RATES, {
      defaultValue: DEFAULT_RATES
    }));
    __privateMethod14(this, _render3, render_fn3).call(this);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_PLAYBACK_RATE && oldValue != newValue) {
      ...
      __privateGet30(this, _rates2).value = newValue;
      __privateMethod14(this, _render3, render_fn3).call(this);
    }
  }
  connectedCallback() {
    super.connectedCallback();
    this.addEventListener("change", __privateMethod14(this, _onChange3, onChange_fn3));
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    this.removeEventListener("change", __privateMethod14(this, _onChange3, onChange_fn3));
  }
  /**
   * Returns the anchor element when it is a floating menu.
   */
   ...
   */
  get rates() {
    return __privateGet30(this, _rates2);
  }
  /**
   * Set the playback rates for the button.
   * For React 19+ compatibility, accept a string of space-separated rates.
  ...
  set rates(value) {
    if (!value) {
      __privateGet30(this, _rates2).value = "";
    } else if (Array.isArray(value)) {
      __privateGet30(this, _rates2).value = value.join(" ");
    } else if (typeof value === "string") {
      __privateGet30(this, _rates2).value = value;
    }
    __privateMethod14(this, _render3, render_fn3).call(this);
  }
  /**
...
render_fn3 = function() {
  ...
  const ratesSet = new Set(Array.from(__privateGet30(this, _rates2)).map((rate) => Number(rate)));
...
var MediaRenditionMenu = class extends MediaChromeMenu {
  constructor() {
    super(...arguments);
    __privateAdd31(this, _render4);
    __privateAdd31(this, _onChange4);
    __privateAdd31(this, _renditionList, []);
    __privateAdd31(this, _prevState3, {});
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
    ...
    if (oldValue !== newValue) {
      switch (attrName) {
        case MediaUIAttributes.MEDIA_RENDITION_SELECTED:
          ...
          __privateMethod15(this, _render4, render_fn4).call(this);
          break;
  ...
  connectedCallback() {
    super.connectedCallback();
    this.addEventListener("change", __privateMethod15(this, _onChange4, onChange_fn4));
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    this.removeEventListener("change", __privateMethod15(this, _onChange4, onChange_fn4));
  }
  /**
   * Returns the anchor element when it is a floating menu.
   */
  ...
  get mediaRenditionList() {
    return __privateGet31(this, _renditionList);
  }
...
render_fn4 = function() {
  ...
  if (__privateGet31(this, _prevState3).mediaRenditionList === JSON.stringify(this.mediaRenditionList) && __privateGet31(this, _prevState3).mediaHeight === this.mediaHeight && __privateGet31(this, _prevState3).mediaWidth === this.mediaWidth && __privateGet31(this, _prevState3).isAuto === isAuto)
    return;
  __privateGet31(this, _prevState3).mediaRenditionList = JSON.stringify(
    this.mediaRenditionList
  );
  __privateGet31(this, _prevState3).mediaHeight = this.mediaHeight;
  __privateGet31(this, _prevState3).mediaWidth = this.mediaWidth;
  __privateGet31(this, _prevState3).isAuto = isAuto;
...
var MediaContextMenu = class extends MediaChromeMenu {
  constructor() {
    super();
    __privateAdd32(this, _updateVisibility);
    __privateAdd32(this, _closeContextMenu);
    __privateAdd32(this, _closeOtherContextMenus);
    __privateAdd32(this, _isVideoContainer);
    __privateAdd32(this, _onContextMenu);
    __privateAdd32(this, _isContextMenuOpen, false);
    __privateAdd32(this, _onControllerContextMenu, (event) => {
      const target = event.target;
      const isVideoElement = (target == null ? void 0 : target.nodeName) === "VIDEO";
      const isVideoContainer = __privateMethod16(this, _isVideoContainer, isVideoContainer_fn).call(this, target);
      if (isVideoElement || isVideoContainer) {
        if (!__privateGet32(this, _isContextMenuOpen)) {
          __privateMethod16(this, _onContextMenu, onContextMenu_fn).call(this, event);
        } else {
          __privateMethod16(this, _closeContextMenu, closeContextMenu_fn).call(this);
        }
      }
    });
    __privateAdd32(this, _onDocumentClick, (event) => {
      const target = event.target;
    ...
    __privateAdd32(this, _onKeyDown, (event) => {
      if (event.key === "Escape") {
        __privateMethod16(this, _closeContextMenu, closeContextMenu_fn).call(this);
      }
    });
    __privateAdd32(this, _onMenuClick, (event) => {
      var _a3, _b;
      const target = event.target;
    ...
    __privateMethod16(this, _updateVisibility, updateVisibility_fn).call(this);
  }
  connectedCallback() {
    super.connectedCallback();
    getMediaController(this).addEventListener(
      "contextmenu",
      __privateGet32(this, _onControllerContextMenu)
    );
    this.addEventListener("click", __privateGet32(this, _onMenuClick));
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    ...
    this.removeEventListener("click", __privateGet32(this, _onMenuClick));
    document.removeEventListener("mousedown", __privateGet32(this, _onDocumentClick));
    document.removeEventListener("keydown", __privateGet32(this, _onKeyDown));
  }
};
_isContextMenuOpen = /* @__PURE__ */ new WeakMap();
_updateVisibility = /* @__PURE__ */ new WeakSet();
updateVisibility_fn = function() {
  this.hidden = !__privateGet32(this, _isContextMenuOpen);
};
...
closeOtherContextMenus_fn = function() {
  ...
  allContextMenus.forEach((menu) => {
    var _a3;
    if (menu !== this) {
      __privateMethod16(_a3 = menu, _closeContextMenu, closeContextMenu_fn).call(_a3);
    }
  });
};
...
onContextMenu_fn = function(event) {
  event.preventDefault();
  __privateMethod16(this, _closeOtherContextMenus, closeOtherContextMenus_fn).call(this);
  __privateSet28(this, _isContextMenuOpen, true);
  this.style.position = "fixed";
  this.style.left = `${event.clientX}px`;
  this.style.top = `${event.clientY}px`;
  __privateMethod16(this, _updateVisibility, updateVisibility_fn).call(this);
  document.addEventListener("mousedown", __privateGet32(this, _onDocumentClick), {
    once: true
  });
  document.addEventListener("keydown", __privateGet32(this, _onKeyDown), { once: true });
};
...
mux-embed/dist/mux.mjs:
  ...
  *)
*/
//# sourceMappingURL=dist-G57ZJCVU.js.map
